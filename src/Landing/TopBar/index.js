...
let text = {
  ...
  portfolio: {en: 'Portfolio', es: 'Portafolio', pl: 'Portfolio'},
}
      ...
      <div>
        <nav className={classNameNavbar}>
          ...
          <div className="navbar-landing-container">
              ...
              <a href="#" className={classNameLink + ' link-empathy hide-on-med-and-down link-topbar'} onClick={this.go2Portfolio}>{text.portfolio[this.props.language].toUpperCase()}</a>
